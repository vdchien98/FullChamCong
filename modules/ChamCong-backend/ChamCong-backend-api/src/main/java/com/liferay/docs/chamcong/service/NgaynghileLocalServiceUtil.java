...
/**
 * Provides the local service utility for Ngaynghile. This utility wraps
 * <code>com.liferay.docs.chamcong.service.impl.NgaynghileLocalServiceImpl</code> and
 ...
 * @generated
 */
public class NgaynghileLocalServiceUtil {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.docs.chamcong.service.impl.NgaynghileLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Ngaynghile addNgaynghile(Ngaynghile ngaynghile) {
	 ...
	 */
	public static Ngaynghile createNgaynghile(int id) {
		return getService().createNgaynghile(id);
	}
	 ...
	 * @return the ngaynghile that was removed
	 */
	public static Ngaynghile deleteNgaynghile(Ngaynghile ngaynghile) {
		return getService().deleteNgaynghile(ngaynghile);
	}
	...
	public static Ngaynghile fetchNgaynghile(int id) {
		return getService().fetchNgaynghile(id);
	}
	 ...
	 * @throws PortalException if a ngaynghile with the primary key could not be found
	 */
	public static Ngaynghile getNgaynghile(int id) throws PortalException {
		return getService().getNgaynghile(id);
	}
	 ...
	 */
	public static List<Ngaynghile> getNgaynghiles(int start, int end) {
		return getService().getNgaynghiles(start, end);
	}
	 ...
	 */
	public static int getNgaynghilesCount() {
		return getService().getNgaynghilesCount();
	}
	 ...
	 */
	public static Ngaynghile updateNgaynghile(Ngaynghile ngaynghile) {
		return getService().updateNgaynghile(ngaynghile);
	}

	public static NgaynghileLocalService getService() {
		return _service;
	}

	private static volatile NgaynghileLocalService _service;
