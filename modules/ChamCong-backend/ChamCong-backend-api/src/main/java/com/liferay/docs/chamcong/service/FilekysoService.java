...
/**
 * Provides the remote service interface for Filekyso. Methods of this
 * service are expected to have security checks based on the propagated JAAS
 * credentials because this service can be accessed remotely.
 *
 * @author Brian Wing Shun Chan
 * @see FilekysoServiceUtil
 * @generated
 */
@AccessControlled
@JSONWebService
...
public interface FilekysoService extends BaseService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.docs.chamcong.service.impl.FilekysoServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the filekyso remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link FilekysoServiceUtil} if injection and service tracking are not available.
	 */
