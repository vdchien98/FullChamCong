...
public interface UsersPersistence extends BasePersistence<Users> {
	 ...
	 */
	public java.util.List<Users> findByUuid(String uuid);
	 ...
	 */
	public java.util.List<Users> findByUuid(String uuid, int start, int end);
	 ...
	 */
	public java.util.List<Users> findByUuid(
