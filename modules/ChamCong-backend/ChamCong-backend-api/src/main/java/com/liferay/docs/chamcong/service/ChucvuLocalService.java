...
/**
 * Provides the local service interface for Chucvu. Methods of this
...
public interface ChucvuLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.docs.chamcong.service.impl.ChucvuLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the chucvu local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link ChucvuLocalServiceUtil} if injection and service tracking are not available.
	 */
	...
	public Chucvu addChucVu(
			String name, int role, ServiceContext serviceContext)
	...
	public Chucvu deleteChucVu(int id, ServiceContext serviceContext)
		throws PortalException;
