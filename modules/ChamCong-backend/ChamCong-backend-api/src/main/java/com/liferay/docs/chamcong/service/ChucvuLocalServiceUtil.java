...
/**
 * Provides the local service utility for Chucvu. This utility wraps
 * <code>com.liferay.docs.chamcong.service.impl.ChucvuLocalServiceImpl</code> and
...
public class ChucvuLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to <code>com.liferay.docs.chamcong.service.impl.ChucvuLocalServiceImpl</code> and rerun ServiceBuilder to regenerate this class.
	 */
	 ...
	 */
	public static Chucvu addChucvu(Chucvu chucvu) {
		return getService().addChucvu(chucvu);
	}

	public static Chucvu addChucVu(
			String name, int role,
			com.liferay.portal.kernel.service.ServiceContext serviceContext)
		throws PortalException, SystemException {

		return getService().addChucVu(name, role, serviceContext);
	}
	 ...
	 */
	public static Chucvu createChucvu(int id) {
	 ...
	 */
	public static Chucvu deleteChucvu(Chucvu chucvu) {
		return getService().deleteChucvu(chucvu);
	}
	 ...
	 */
	public static Chucvu deleteChucvu(int id) throws PortalException {
		return getService().deleteChucvu(id);
	}

	public static Chucvu deleteChucVu(
			int id,
			com.liferay.portal.kernel.service.ServiceContext serviceContext)
		throws PortalException {

		return getService().deleteChucVu(id, serviceContext);
	}
	...
	public static Chucvu fetchChucvu(int id) {
	 ...
	 * @throws PortalException if a chucvu with the primary key could not be found
	 */
	public static Chucvu getChucvu(int id) throws PortalException {
	 ...
	 */
	public static List<Chucvu> getChucvus(int start, int end) {
	 ...
	 */
	public static Chucvu updateChucvu(Chucvu chucvu) {
		return getService().updateChucvu(chucvu);
	}

	public static Chucvu updateChucVu(
	...
	private static volatile ChucvuLocalService _service;
