...
public interface CalamviecLocalService
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.docs.chamcong.service.impl.CalamviecLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the calamviec local service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link CalamviecLocalServiceUtil} if injection and service tracking are not available.
	 */
