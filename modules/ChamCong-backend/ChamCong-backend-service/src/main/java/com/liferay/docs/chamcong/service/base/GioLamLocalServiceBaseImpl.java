...
/**
 * Provides the base implementation for the gio lam local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.docs.chamcong.service.impl.GioLamLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.docs.chamcong.service.impl.GioLamLocalServiceImpl
 * @generated
 */
public abstract class GioLamLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, GioLamLocalService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>GioLamLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>GioLamLocalServiceUtil</code>.
	 */
	...
	public GioLam addGioLam(GioLam gioLam) {
		...
		return gioLamPersistence.update(gioLam);
	}
	...
	public GioLam createGioLam(int id) {
		return gioLamPersistence.create(id);
	}
	...
	public GioLam deleteGioLam(int id) throws PortalException {
		return gioLamPersistence.remove(id);
	}
	...
	public GioLam deleteGioLam(GioLam gioLam) {
		return gioLamPersistence.remove(gioLam);
	}

	@Override
	public <T> T dslQuery(DSLQuery dslQuery) {
		return gioLamPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			GioLam.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(DynamicQuery dynamicQuery) {
		return gioLamPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return gioLamPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return gioLamPersistence.findWithDynamicQuery(
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery) {
		return gioLamPersistence.countWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(
		...
		return gioLamPersistence.countWithDynamicQuery(
			dynamicQuery, projection);
	}

	@Override
	public GioLam fetchGioLam(int id) {
		return gioLamPersistence.fetchByPrimaryKey(id);
	}
	...
	public GioLam getGioLam(int id) throws PortalException {
		return gioLamPersistence.findByPrimaryKey(id);
	}
	...
	public ActionableDynamicQuery getActionableDynamicQuery() {
		...
		actionableDynamicQuery.setBaseLocalService(gioLamLocalService);
		actionableDynamicQuery.setClassLoader(getClassLoader());
		actionableDynamicQuery.setModelClass(GioLam.class);
	...
	public IndexableActionableDynamicQuery
		...
		indexableActionableDynamicQuery.setBaseLocalService(gioLamLocalService);
		indexableActionableDynamicQuery.setClassLoader(getClassLoader());
		indexableActionableDynamicQuery.setModelClass(GioLam.class);
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return gioLamPersistence.create(((Integer)primaryKeyObj).intValue());
	}
	...
	public PersistedModel deletePersistedModel(PersistedModel persistedModel)
		...
		return gioLamLocalService.deleteGioLam((GioLam)persistedModel);
	}

	@Override
	public BasePersistence<GioLam> getBasePersistence() {
		return gioLamPersistence;
	}
	...
	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		...
		return gioLamPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<GioLam> getGioLams(int start, int end) {
		return gioLamPersistence.findAll(start, end);
	}
	...
	public int getGioLamsCount() {
		return gioLamPersistence.countAll();
	}
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			GioLamLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		gioLamLocalService = (GioLamLocalService)aopProxy;

		_setLocalServiceUtilService(gioLamLocalService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return GioLamLocalService.class.getName();
	}
	...
	private void _setLocalServiceUtilService(
		GioLamLocalService gioLamLocalService) {

		try {
			Field field = GioLamLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, gioLamLocalService);
		}
	...
	protected GioLamLocalService gioLamLocalService;
