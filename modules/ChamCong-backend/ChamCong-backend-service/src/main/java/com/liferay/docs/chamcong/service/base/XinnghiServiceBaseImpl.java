...
import com.liferay.docs.chamcong.service.XinnghiService;
...
/**
 * Provides the base implementation for the xinnghi remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.docs.chamcong.service.impl.XinnghiServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.docs.chamcong.service.impl.XinnghiServiceImpl
 * @generated
 */
public abstract class XinnghiServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, IdentifiableOSGiService, XinnghiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>XinnghiService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>XinnghiServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			XinnghiService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		xinnghiService = (XinnghiService)aopProxy;

		_setServiceUtilService(xinnghiService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return XinnghiService.class.getName();
	}
	...
	private void _setServiceUtilService(XinnghiService xinnghiService) {
		try {
			Field field = XinnghiServiceUtil.class.getDeclaredField("_service");

			field.setAccessible(true);

			field.set(null, xinnghiService);
		}
	...
	@Reference
	protected com.liferay.docs.chamcong.service.XinnghiLocalService
		xinnghiLocalService;

	protected XinnghiService xinnghiService;
