...
import com.liferay.docs.chamcong.service.CalamviecService;
import com.liferay.docs.chamcong.service.CalamviecServiceUtil;
...
/**
 * Provides the base implementation for the calamviec remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.docs.chamcong.service.impl.CalamviecServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.docs.chamcong.service.impl.CalamviecServiceImpl
 * @generated
 */
public abstract class CalamviecServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, CalamviecService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>CalamviecService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>CalamviecServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			CalamviecService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		calamviecService = (CalamviecService)aopProxy;

		_setServiceUtilService(calamviecService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return CalamviecService.class.getName();
	}
	...
	private void _setServiceUtilService(CalamviecService calamviecService) {
		try {
			Field field = CalamviecServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, calamviecService);
		}
	...
	@Reference
	protected com.liferay.docs.chamcong.service.CalamviecLocalService
		calamviecLocalService;

	protected CalamviecService calamviecService;
