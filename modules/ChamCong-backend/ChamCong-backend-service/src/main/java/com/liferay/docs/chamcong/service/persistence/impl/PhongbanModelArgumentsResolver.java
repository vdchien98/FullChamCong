...
/**
 * The arguments resolver class for retrieving value from Phongban.
 *
...
@Component(
	immediate = true,
	service = {PhongbanModelArgumentsResolver.class, ArgumentsResolver.class}
)
public class PhongbanModelArgumentsResolver implements ArgumentsResolver {
	...
	public Object[] getArguments(
		...
		if (finderPathColumnBitmask == null) {
			...
			for (String columnName : columnNames) {
				finderPathColumnBitmask |= phongbanModelImpl.getColumnBitmask(
					columnName);
			}
	...
	public String getClassName() {
		return PhongbanImpl.class.getName();
	}

	@Override
	public String getTableName() {
		return PhongbanTable.INSTANCE.getTableName();
	}
