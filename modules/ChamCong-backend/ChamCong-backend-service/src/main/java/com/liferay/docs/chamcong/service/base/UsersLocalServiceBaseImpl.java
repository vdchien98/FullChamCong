 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.docs.chamcong.service.impl.UsersLocalServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.docs.chamcong.service.impl.UsersLocalServiceImpl
 * @generated
 */
public abstract class UsersLocalServiceBaseImpl
	extends BaseLocalServiceImpl
	implements AopService, IdentifiableOSGiService, UsersLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>UsersLocalService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>UsersLocalServiceUtil</code>.
	 */
	...
	public <T> T dslQuery(DSLQuery dslQuery) {
		return usersPersistence.dslQuery(dslQuery);
	}
	...
	public DynamicQuery dynamicQuery() {
		...
		return DynamicQueryFactoryUtil.forClass(
			Users.class, clazz.getClassLoader());
	}
	...
	public <T> List<T> dynamicQuery(
		...
		return usersPersistence.findWithDynamicQuery(
	...
	public PersistedModel createPersistedModel(Serializable primaryKeyObj)
		...
		return usersPersistence.create(((Integer)primaryKeyObj).intValue());
	}
	...
	@Override
	public BasePersistence<Users> getBasePersistence() {
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			UsersLocalService.class, IdentifiableOSGiService.class,
	...
	public void setAopProxy(Object aopProxy) {
		usersLocalService = (UsersLocalService)aopProxy;

		_setLocalServiceUtilService(usersLocalService);
	}
	...
	private void _setLocalServiceUtilService(
		...
		try {
			Field field = UsersLocalServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, usersLocalService);
		}
