...
import com.liferay.docs.chamcong.service.FilekysoService;
...
/**
 * Provides the base implementation for the filekyso remote service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link com.liferay.docs.chamcong.service.impl.FilekysoServiceImpl}.
 * </p>
 *
 * @author Brian Wing Shun Chan
 * @see com.liferay.docs.chamcong.service.impl.FilekysoServiceImpl
 * @generated
 */
public abstract class FilekysoServiceBaseImpl
	extends BaseServiceImpl
	implements AopService, FilekysoService, IdentifiableOSGiService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Use <code>FilekysoService</code> via injection or a <code>org.osgi.util.tracker.ServiceTracker</code> or use <code>FilekysoServiceUtil</code>.
	 */
	@Deactivate
	...
	public Class<?>[] getAopInterfaces() {
		return new Class<?>[] {
			FilekysoService.class, IdentifiableOSGiService.class
		};
	}

	@Override
	public void setAopProxy(Object aopProxy) {
		filekysoService = (FilekysoService)aopProxy;

		_setServiceUtilService(filekysoService);
	}
	...
	public String getOSGiServiceIdentifier() {
		return FilekysoService.class.getName();
	}
	...
	private void _setServiceUtilService(FilekysoService filekysoService) {
		try {
			Field field = FilekysoServiceUtil.class.getDeclaredField(
				"_service");

			field.setAccessible(true);

			field.set(null, filekysoService);
		}
	...
	@Reference
	protected com.liferay.docs.chamcong.service.FilekysoLocalService
		filekysoLocalService;

	protected FilekysoService filekysoService;
