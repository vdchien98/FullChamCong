...
<portlet:renderURL var="filePDFURL">
	<portlet:param name="mvcPath" value="/xin_nghi/donXinNghi.jsp"></portlet:param>
</portlet:renderURL>
        ...
        <div class="card-body">
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
						...
						<aui:button-row>
							<aui:button iconCssClass="icon-plus"
								onClick="<%=filePDFURL.toString()%>" value="Tạo File "></aui:button>
						</aui:button-row>
						<a href="" class="btn btn-info ml-3"><i class="far fa-calendar-times"></i> Xin nghỉ nửa ngày</a>
                        </div>
                        ...
                        <tbody>
                                <tr>
                                    ...
                                    <td>
                                            ...
                                            <span class="text-info font-weight-bold">Từ ngày: </span> từ ngày 6-8-2023 <br>
                                            <span class="text-warning font-weight-bold">Đến ngày: </span> đến ngày 8-8-2023 <br>
                                    </td>
                                    <td>
